...
class tic_tac_toe_game:
    def __init__(self, players = DEFAULT_PLAYER, board_size = BOARD_SIZE):
    ...
    def _get_winning_combos(self):
        ...
        second_diagonal = [
            col[j] for j, col in enumerate(reversed( columns))
        ]
